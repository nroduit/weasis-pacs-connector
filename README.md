...
[![License](https://img.shields.io/badge/License-EPL%202.0-blue.svg)](https://opensource.org/licenses/EPL-2.0) ![Build](https://github.com/nroduit/weasis-pacs-connector/workflows/Build/badge.svg)  
[![Sonar](https://sonarcloud.io/api/project_badges/measure?project=weasis-pacs-connector&metric=ncloc)](https://sonarcloud.io/component_measures?id=weasis-pacs-connector) [![Sonar](https://sonarcloud.io/api/project_badges/measure?project=weasis-pacs-connector&metric=reliability_rating)](https://sonarcloud.io/component_measures?id=weasis-pacs-connector) [![Sonar](https://sonarcloud.io/api/project_badges/measure?project=weasis-pacs-connector&metric=sqale_rating)](https://sonarcloud.io/component_measures?id=weasis-pacs-connector) [![Sonar](https://sonarcloud.io/api/project_badges/measure?project=weasis-pacs-connector&metric=security_rating)](https://sonarcloud.io/component_measures?id=weasis-pacs-connector) [![Sonar](https://sonarcloud.io/api/project_badges/measure?project=weasis-pacs-connector&metric=alert_status)](https://sonarcloud.io/dashboard?id=weasis-pacs-connector)  
