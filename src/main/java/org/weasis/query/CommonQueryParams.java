...
public class CommonQueryParams {
  ...
  // Archive property name to be used instead of those defined by "arc.config.list" in component
  // properties
  ...
  public static final Consumer<Collection<String>> removeWadoQueryParams =
      c -> c.removeAll(wadoQueryParams);
  public static final Consumer<Collection<String>> retainWadoQueryParams =
      c -> c.retainAll(wadoQueryParams);
  ...
  public static boolean isManifestRequest(Map<String, String[]> map) {
    ...
    return map.get(REQUEST_TYPE) != null
        || map.get(PATIENT_ID) != null
        || map.get(STUDY_UID) != null
        || map.get(ACCESSION_NUMBER) != null
        || map.get(SERIES_UID) != null
        || map.get(OBJECT_UID) != null;
  }
}
